...
public final class FantasyTerrainConfig {
    ...
    public static final Codec<FantasyTerrainConfig> CODEC = RecordCodecBuilder.create(i -> i.group(
            ...
            Codec.DOUBLE.optionalFieldOf("detail_scale", 0.060).forGetter(FantasyTerrainConfig::detailScale),
            Codec.DOUBLE.optionalFieldOf("detail_amplitude", 6.5).forGetter(FantasyTerrainConfig::detailAmplitude),
